!(function (t, e) {
    ...
    function V() {
        var t = m(C().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(
                function (t, e) {
                    return (
        ...
        if (n) {
            !(function (t, e) {
                'string' == typeof e
                    ...
                    : e || st([document.documentElement, document.body], z['no-backdrop']);
            })(n, e.backdrop),
                !e.backdrop &&
                    e.allowOutsideClick &&
                    D(
        ...
        return new Promise(function (t) {
            ...
            (_t.restoreFocusTimeout = setTimeout(function () {
                _t.previousActiveElement && _t.previousActiveElement.focus
                    ? (_t.previousActiveElement.focus(), (_t.previousActiveElement = null))
    ...
    function ee(t, e, n, o) {
        n
            ...
            I() &&
                ...
                'undefined' != typeof window && Jt() && window.removeEventListener('resize', Xt),
            ...
            ut(
                [document.documentElement, document.body],
                [z.shown, z['height-auto'], z['no-backdrop'], z['toast-shown'], z['toast-column']]
            );
    }
    function ne(t) {
        var e = C();
    ...
    function pe(t) {
        ...
        'function' == typeof t.onBeforeOpen && t.onBeforeOpen(n),
            ...
            K() || _t.previousActiveElement || (_t.previousActiveElement = document.activeElement),
    ...
    var we = function (t, e) {
            ht && et(e)
                ? ((t.style.overflowY = 'hidden'), e.addEventListener(ht, de.bind(null, e, t)))
